...
function generateFractal() {
    ...
    setTimeout(() => {
        initializeWebGL(real, imag, zoom, iterations, paramA, paramB, width, height, seed);
        wait_msg.innerHTML = "";
...
function saveFractal() {
    // Implement the functionality to save the canvas image if required.
}

function initializeWebGL(centerReal, centerImag, zoom, iterations, paramA, paramB, width, height, seed) {
    ...
    gl.uniform2f(paramUniformLocation, paramA, paramB);
